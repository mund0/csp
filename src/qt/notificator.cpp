...
//jpjp extern bool qt_mac_execute_apple_script(const QString &script, AEDesc *ret);
#endif
...
//jpjp    qt_mac_execute_apple_script(script.arg(notificationApp, quotedTitle, quotedText, notificationIcon, growlApp), 0);
}
#endif
